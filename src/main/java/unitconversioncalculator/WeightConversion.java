public class WeightConversion {
    ...
    public static String weightConversion(Enum before_command, Enum after_command, double num){
        if(before_command == weightEnum.TON){
            if(after_command == weightEnum.TON){
                result.append(num);
            }
            else if(after_command == weightEnum.BRITISH_TON){
                result.append(num * 0.9842065276);
            }
            else if(after_command == weightEnum.US_TON){
                result.append(num * 1.1023113109);
            }
            else if(after_command == weightEnum.POUND){
                result.append(num * 2204.6226218488);
            }
            else if(after_command == weightEnum.OUNCE){
                result.append(num * 35273.96194958);
            }
            else if(after_command == weightEnum.KILOGRAM){
                result.append(num * 1000);
            }
            else if(after_command == weightEnum.GRAM){
                result.append(num * 1000000);
            }
        }
        else if(before_command == weightEnum.BRITISH_TON){
            if(after_command == weightEnum.TON){
        ...
        else if(before_command == weightEnum.US_TON){
            if(after_command == weightEnum.TON){
        ...
        else if(before_command == weightEnum.POUND){
            if(after_command == weightEnum.TON){
        ...
        else if(before_command == weightEnum.OUNCE){
            if(after_command == weightEnum.TON){
        ...
        else if(before_command == weightEnum.KILOGRAM){
            if(after_command == weightEnum.TON){
        ...
        else if(before_command == weightEnum.GRAM){
            if(after_command == weightEnum.TON){
