public class LengthConversion {
    ...
    public static String lengthConversion(Enum before_command, Enum after_command, double num){
        if(before_command == lengthEnum.MILLIMETER){
            if(after_command == lengthEnum.MILLIMETER){
                result.append(num);
            }
            else if(after_command == lengthEnum.CENTIMETER){
                result.append(num * 0.1);
            }
            else if(after_command == lengthEnum.METER){
                result.append(num * 0.001);
            }
            else if(after_command == lengthEnum.KILOMETER){
                result.append(num * 0.000001);
            }
            else if(after_command == lengthEnum.INCH){
                result.append(num * 0.0393700787);
            }
            else if(after_command == lengthEnum.FEET){
                result.append(num * 0.0032808399);
            }
            else if(after_command == lengthEnum.YARD){
                result.append(num * 0.0010936133);
            }
            else if(after_command == lengthEnum.MILE){
                result.append(num * 6.2137119 * Math.pow(10, -7));
            }
            else if(after_command == lengthEnum.NMILE){
                result.append(num * 5.39956803 * Math.pow(10, -7));
            }
            else if(after_command == lengthEnum.MIL){
                result.append(num * 39.3700787402);
            }
        }
        else if(before_command == lengthEnum.CENTIMETER){
            if(after_command == lengthEnum.MILLIMETER){
        ...
        else if(before_command == lengthEnum.METER){
            if(after_command == lengthEnum.MILLIMETER){
        ...
        else if(before_command == lengthEnum.KILOMETER){
            if(after_command == lengthEnum.MILLIMETER){
        ...
        else if(before_command == lengthEnum.INCH){
            if(after_command == lengthEnum.MILLIMETER){
        ...
        else if(before_command == lengthEnum.FEET){
            if(after_command == lengthEnum.MILLIMETER){
        ...
        else if(before_command == lengthEnum.YARD){
            if(after_command == lengthEnum.MILLIMETER){
        ...
        else if(before_command == lengthEnum.MILE){
            if(after_command == lengthEnum.MILLIMETER){
        ...
        else if(before_command == lengthEnum.NMILE){
            if(after_command == lengthEnum.MILLIMETER){
        ...
        else if(before_command == lengthEnum.MIL){
            if(after_command == lengthEnum.MILLIMETER){
                result.append(num * 0.0254);
            }
            else if(after_command == lengthEnum.CENTIMETER){
