public class VolumeConversion {
    ...
    public static String volumeConversion(String before_command, String after_command, double num){
        if(before_command.equals(String.valueOf(volumeEnum.BRITISH_GALLON))){
            if(after_command.equals(String.valueOf(volumeEnum.BRITISH_GALLON))){
                result.append(num);
            }
            else if(after_command.equals(String.valueOf(volumeEnum.US_GALLON))){
                result.append(num * 1.2009499255);
            }
            else if(after_command.equals(String.valueOf(volumeEnum.LITER))){
                result.append(num * 4.54609);
            }
            else if(after_command.equals(String.valueOf(volumeEnum.MILLILITER))){
                result.append(num * 4546.09);
            }
            else if(after_command.equals(String.valueOf(volumeEnum.CUBIC_CENTIMETER))){
                result.append(num * 4546.09);
            }
            else if(after_command.equals(String.valueOf(volumeEnum.CUBIC_METER))){
                result.append(num * 0.00454609);
            }
            else if(after_command.equals(String.valueOf(volumeEnum.CUBIC_INCH))){
                result.append(num * 277.4194327916);
            }
            else if(after_command.equals(String.valueOf(volumeEnum.CUBIC_FEET))){
                result.append(num * 0.1605436532);
            }
        }
        else if(before_command.equals(String.valueOf(volumeEnum.US_GALLON))){
            if(after_command.equals(String.valueOf(volumeEnum.BRITISH_GALLON))){
        ...
        else if(before_command.equals(String.valueOf(volumeEnum.LITER))){
            if(after_command.equals(String.valueOf(volumeEnum.BRITISH_GALLON))){
        ...
        else if(before_command.equals(String.valueOf(volumeEnum.MILLILITER))){
            if(after_command.equals(String.valueOf(volumeEnum.BRITISH_GALLON))){
        ...
        else if(before_command.equals(String.valueOf(volumeEnum.CUBIC_CENTIMETER))){
            if(after_command.equals(String.valueOf(volumeEnum.BRITISH_GALLON))){
                result.append(num * 0.0002199692);
            }
            else if(after_command.equals(String.valueOf(volumeEnum.US_GALLON))){
        ...
        else if(before_command.equals(String.valueOf(volumeEnum.CUBIC_METER))){
            if(after_command.equals(String.valueOf(volumeEnum.BRITISH_GALLON))){
        ...
        else if(before_command.equals(String.valueOf(volumeEnum.CUBIC_INCH))){
            if(after_command.equals(String.valueOf(volumeEnum.BRITISH_GALLON))){
        ...
        else if(before_command.equals(String.valueOf(volumeEnum.CUBIC_FEET))){
            if(after_command.equals(String.valueOf(volumeEnum.BRITISH_GALLON))){
