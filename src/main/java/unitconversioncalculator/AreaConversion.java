public class AreaConversion {
    ...
    public static String areaConversion(Enum before_command, Enum after_command, double num){
        if(before_command == areaEnum.ACRE){
            if(after_command == areaEnum.ACRE){
                result.append(num);
            }
            else if(after_command == areaEnum.ARE){
                result.append(num * 40.468564224);
            }
            else if(after_command == areaEnum.HECTARE){
                result.append(num * 0.4046856422);
            }
            else if(after_command == areaEnum.SQUARE_CENTIMETER){
                result.append(num * 40468564.224);
            }
            else if(after_command == areaEnum.SQUARE_FEET){
                result.append(num * 43560);
            }
            else if(after_command == areaEnum.SQUARE_INCH){
                result.append(num * 6272640);
            }
            else if(after_command == areaEnum.SQUARE_METER){
                result.append(num * 4046.8564224);
            }
            else if(after_command == areaEnum.PYEONG){
                result.append(num * 1224.1741136825);
            }
        }
        else if(before_command == areaEnum.ARE){
            if(after_command == areaEnum.ACRE){
        ...
        else if(before_command == areaEnum.HECTARE){
            if(after_command == areaEnum.ACRE){
        ...
        else if(before_command == areaEnum.SQUARE_CENTIMETER){
            if(after_command == areaEnum.ACRE){
        ...
        else if(before_command == areaEnum.SQUARE_FEET){
            if(after_command == areaEnum.ACRE){
        ...
        else if(before_command == areaEnum.SQUARE_INCH){
            if(after_command == areaEnum.ACRE){
        ...
        else if(before_command == areaEnum.SQUARE_METER){
            if(after_command == areaEnum.ACRE) {
        ...
        else if(before_command == areaEnum.PYEONG){
            if(after_command == areaEnum.ACRE) {
