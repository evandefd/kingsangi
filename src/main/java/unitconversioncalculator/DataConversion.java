public class DataConversion {
    ...
    public static String dataConversion(Enum before_command, Enum after_command, double num){
        if(before_command == dataEnum.BIT){
            if(after_command == dataEnum.BIT){
                result.append(num);
            }
            else if(after_command == dataEnum.BYTE){
                result.append(num * 0.125);
            }
            else if(after_command == dataEnum.KILOBYTE){
                result.append(num * 0.0001220703);
            }
            else if(after_command == dataEnum.MEGABYTE){
                result.append(num * 1.19209290 * Math.pow(10, -7));
            }
            else if(after_command == dataEnum.GIGABYTE){
                result.append(num * 1.16415322 * Math.pow(10, -10));
            }
            else if(after_command == dataEnum.TERABYTE){
                result.append(num * 1.13686838 * Math.pow(10, -13));
            }
        }
        else if(before_command == dataEnum.BYTE){
            if(after_command == dataEnum.BIT){
                result.append(num * 8);
            }
            else if(after_command == dataEnum.BYTE){
        ...
        else if(before_command == dataEnum.KILOBYTE){
            if(after_command == dataEnum.BIT){
        ...
        else if(before_command == dataEnum.MEGABYTE){
            if(after_command == dataEnum.BIT){
        ...
        else if(before_command == dataEnum.GIGABYTE){
            if(after_command == dataEnum.BIT){
        ...
        else if(before_command == dataEnum.TERABYTE){
            if(after_command == dataEnum.BIT){
