public class SpeedConversion {
    ...
    public static String speedConversion(Enum before_command, Enum after_command, double num){
        if(before_command == speedEnum.METER_PER_SECOND){
            if(after_command == speedEnum.METER_PER_SECOND){
                result.append(num);
            }
            else if(after_command == speedEnum.METER_PER_HOUR){
                result.append(num * 3600);
            }
            else if(after_command == speedEnum.KILOMETER_PER_SECOND){
                result.append(num * 0.001);
            }
            else if(after_command == speedEnum.KILOMETER_PER_HOUR){
                result.append(num * 3.6);
            }
            else if(after_command == speedEnum.INCH_PER_SECOND){
                result.append(num * 39.3700787402);
            }
            else if(after_command == speedEnum.INCH_PER_HOUR){
                result.append(num * 141732.28346457);
            }
            else if(after_command == speedEnum.FEET_PER_SECOND){
                result.append(num * 3.280839895);
            }
            else if(after_command == speedEnum.FEET_PER_HOUR){
                result.append(num * 11811.023622047);
            }
            else if(after_command == speedEnum.MILE_PER_SECOND){
                result.append(num * 0.0006213712);
            }
            else if(after_command == speedEnum.MILE_PER_HOUR){
                result.append(num * 2.2369362921);
            }
            else if(after_command == speedEnum.KNOT){
                result.append(num * 1.9438444924);
            }
        }
        else if(before_command == speedEnum.METER_PER_HOUR){
            if(after_command == speedEnum.METER_PER_SECOND){
        ...
        else if(before_command == speedEnum.KILOMETER_PER_SECOND){
            if(after_command == speedEnum.METER_PER_SECOND){
        ...
        else if(before_command == speedEnum.KILOMETER_PER_HOUR){
            if(after_command == speedEnum.METER_PER_SECOND){
        ...
        else if(before_command == speedEnum.INCH_PER_SECOND){
            if(after_command == speedEnum.METER_PER_SECOND){
        ...
        else if(before_command == speedEnum.INCH_PER_HOUR){
            if(after_command == speedEnum.METER_PER_SECOND){
        ...
        else if(before_command == speedEnum.FEET_PER_SECOND){
            if(after_command == speedEnum.METER_PER_SECOND){
        ...
        else if(before_command == speedEnum.FEET_PER_HOUR){
            if(after_command == speedEnum.METER_PER_SECOND){
        ...
        else if(before_command == speedEnum.MILE_PER_SECOND){
            if(after_command == speedEnum.METER_PER_SECOND){
        ...
        else if(before_command == speedEnum.MILE_PER_HOUR){
            if(after_command == speedEnum.METER_PER_SECOND){
        ...
        else if(before_command == speedEnum.KNOT){
            if(after_command == speedEnum.METER_PER_SECOND){
