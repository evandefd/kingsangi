public class SpeedConversion {
    private static final String[] BEFORE_SPEED_UNIT = {"meter_per_second", "meter_per_hour", "kilometer_per_second", "kilometer_per_hour", "inch_per_second", "inch_per_hour",
            "feet_per_second", "feet_per_hour", "mile_per_second", "mile_per_hour", "knot"};
    public static final String[] AFTER_SPEED_UNIT = {"meter_per_second", "meter_per_hour", "kilometer_per_second", "kilometer_per_hour", "inch_per_second", "inch_per_hour",
            "feet_per_second", "feet_per_hour", "mile_per_second", "mile_per_hour", "knot"};
    private static final StringBuilder result = new StringBuilder();
    public static String speedConversion(String before_command, String after_command, double num){
        if(before_command.equals(BEFORE_SPEED_UNIT[0])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
                result.append(num);
            }
            else if(after_command.equals(AFTER_SPEED_UNIT[1])){
                result.append(num * 3600);
            }
            else if(after_command.equals(AFTER_SPEED_UNIT[2])){
                result.append(num * 0.001);
            }
            else if(after_command.equals(AFTER_SPEED_UNIT[3])){
                result.append(num * 3.6);
            }
            else if(after_command.equals(AFTER_SPEED_UNIT[4])){
                result.append(num * 39.3700787402);
            }
            else if(after_command.equals(AFTER_SPEED_UNIT[5])){
                result.append(num * 141732.28346457);
            }
            else if(after_command.equals(AFTER_SPEED_UNIT[6])){
                result.append(num * 3.280839895);
            }
            else if(after_command.equals(AFTER_SPEED_UNIT[7])){
                result.append(num * 11811.023622047);
            }
            else if(after_command.equals(AFTER_SPEED_UNIT[8])){
                result.append(num * 0.0006213712);
            }
            else if(after_command.equals(AFTER_SPEED_UNIT[9])){
                result.append(num * 2.2369362921);
            }
            else if(after_command.equals(AFTER_SPEED_UNIT[10])){
                result.append(num * 1.9438444924);
            }
        }
        else if(before_command.equals(BEFORE_SPEED_UNIT[1])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
        ...
        else if(before_command.equals(BEFORE_SPEED_UNIT[2])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
        ...
        else if(before_command.equals(BEFORE_SPEED_UNIT[3])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
        ...
        else if(before_command.equals(BEFORE_SPEED_UNIT[4])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
        ...
        else if(before_command.equals(BEFORE_SPEED_UNIT[5])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
        ...
        else if(before_command.equals(BEFORE_SPEED_UNIT[6])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
        ...
        else if(before_command.equals(BEFORE_SPEED_UNIT[7])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
        ...
        else if(before_command.equals(BEFORE_SPEED_UNIT[8])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
        ...
        else if(before_command.equals(BEFORE_SPEED_UNIT[9])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
        ...
        else if(before_command.equals(BEFORE_SPEED_UNIT[10])){
            if(after_command.equals(AFTER_SPEED_UNIT[0])){
