...
public enum VolumeUnitConvertor {
    BRITISH_GALLON{
        @Override
        BigDecimal convert(BigDecimal value, VolumeUnitConvertor volumeUnit) {
    ...
    abstract BigDecimal convert(BigDecimal value, VolumeUnitConvertor volumeUnit);
}
